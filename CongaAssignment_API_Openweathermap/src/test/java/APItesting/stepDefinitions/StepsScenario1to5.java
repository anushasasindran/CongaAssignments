...
import APItesting.resouces.OpenWeatherMap;


	public class StepsScenario1to5 extends OpenWeatherMap {
		    ...
		    public void iHaveRegisteredANewStationToOpenWhetherMapWithValuesOf(String external_id, String name, String longitude, String latitude, String altitude)  {
		        ...
		        latestStationID = getValueByKey(currentResponse, "ID"); 
		    }
		    ...
		    @When("^I delete my latest station associated with my APIKey in OpenWeatherMap$")
		    ...
		    @Given("^I have cleaned all stations associated with my APIKey in OpenWeatherMap$")
		    public void iHaveCleanedAllStationsAssociatedWithMyAPIKeyInOpenWhetherMap()  {
		        int statusCode = deleteAllStations(APIKEY); 
		    }
