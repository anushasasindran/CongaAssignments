Feature: API Testing for OpenWeatherMap
  ...
  Scenario: Test 1: Validate that attempt to register a weather station "without" an APIKey (response code = 401 - error)
    # Test 1
    ...
    Then I should see the message body with "code" as "401"
  ...
  Scenario Outline: Test 2 to Test 5:
   ...
   Examples:
   | external_id  | name             | latitude | longitude | altitude |
   | DEMO_TEST001 | Test Station 001 |   33.33  |  -111.43  |   444   |
   | DEMO_TEST002 | Test Station 002 |   33.44  |  -122.44  |   444    |
